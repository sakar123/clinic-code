...
public class ToothApiTests : IClassFixture<ApiTestFixture>
{
    ...
    public async Task GetAll_WhenCalled_ReturnsOk()
    {
        ...
        // Act
        var response = await _client.GetAsync("/api/Teeth");
    ...
    {
        // Arrange
        var payload = TestDataFactory.Tooth();

        // Act
        var response = await _client.PostAsync("/api/Teeth", JsonSnakeCaseContent.From(payload));
    ...
    public async Task GetById_WhenUnknown_ReturnsNotFound()
    {
        ...
        // Act
        var response = await _client.GetAsync("/api/Teeth/" + id);
    ...
    public async Task Put_WhenIdMismatch_ReturnsBadRequestOrUnprocessable()
    {
        ...
        // Act
        var response = await _client.PutAsync("/api/Teeth/" + id, JsonSnakeCaseContent.From(payload));
    ...
    public async Task Delete_WhenUnknownId_ReturnsNotFoundOrNoContent()
    {
        ...
        // Act
        var response = await _client.DeleteAsync("/api/Teeth/" + id);
