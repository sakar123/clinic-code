...
public class TreatmentApiTests : IClassFixture<ApiTestFixture>
{
    ...
    {
        // Arrange
        var payload = TestDataFactory.Treatment();

        // Act
        var response = await _client.PostAsync("/api/Treatments", JsonSnakeCaseContent.From(payload));
    ...
    public async Task GetById_WhenUnknown_ReturnsNotFound()
    {
        ...
        // Act
        var response = await _client.GetAsync("/api/Treatments/" + id);
    ...
    public async Task Put_WhenIdMismatch_ReturnsBadRequestOrUnprocessable()
    {
        ...
        // Act
        var response = await _client.PutAsync("/api/Treatments/" + id, JsonSnakeCaseContent.From(payload));
    ...
    public async Task Delete_WhenUnknownId_ReturnsNotFoundOrNoContent()
    {
        ...
        // Act
        var response = await _client.DeleteAsync("/api/Treatments/" + id);
